<div>
    @if ($flag == false)
        <button type="submit" wire:click='createOrUpdate' class="btn btn-primary mb-3">Create</button>
    @else
        <button type="submit" wire:click='createOrUpdate' class="btn btn-primary mb-3">Table</button>
    @endif
    @if ($flag)
        @if ($offerId)
            <form wire:submit.prevent="updateOffer({{ $offerId }})">
                @csrf
            @else
                                        ...
                                        <tr>
                                            ...
                                            <td> <button class="modal-effect btn btn-sm btn-danger"
                                                ...
                                                <button class="modal-effect btn btn-sm btn-info"
                                                    wire:click="setValues({{ $offer->id }})"
                                                    data-effect="effect-scale"><i class="las la-pen"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
